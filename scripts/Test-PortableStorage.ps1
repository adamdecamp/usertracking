...
try {
    ...
    & $compiler /nologo /target:exe "/out:$testExecutable" /reference:System.Web.Extensions.dll /reference:System.IO.Compression.dll /reference:System.IO.Compression.FileSystem.dll (Join-Path $projectRoot "portable-launcher\PortableStorage.cs") (Join-Path $projectRoot "tests\PortableStorageTests.cs")
