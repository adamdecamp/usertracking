...
const labels:[label:string,target:string][]= [
 ...
 ['DTA Training','DTA_Training_Cert'],
 ['DTA Course','DTA_Training_Cert'],
 ['DTA Responsibilities','DTA_Training_Cert'],
 ['Delegated Trusted Agent Training','DTA_Training_Cert'],
 ['Delegated Trusted Agent Course','DTA_Training_Cert'],
