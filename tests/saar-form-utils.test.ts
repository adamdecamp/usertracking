...
test('parses supported requester signature dates and rejects impossible dates',()=>{
 assert.equal(parseSaarRequestDate("D:20260826153000-06'00'"),'2026-08-26');
 assert.equal(parseSaarRequestDate('26AUG2026'),'2026-08-26');
 assert.equal(parseSaarRequestDate('AUG 26 2026'),'2026-08-26');
 assert.equal(parseSaarRequestDate('02/31/2026'),undefined);
});
