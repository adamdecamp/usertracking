...
internal static class PortableStorageTests
{
    ...
    public static int Main(string[] args)
    {
        ...
        Assert(retentionMoves.Length == 7, "Archive preflight should move disabled SAARs, repair misplaced archives, and move outdated active and Rework evidence before the main scan.");
